...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    FMResultSet *s = [_db executeQuery:@"SELECT ID,NAME,DOWNLOAD_PATH,DURATION,SCHEDULE,SIZE,COURSE_ID,DOWNLOAD_FINISH FROM CHAPTER_LIST "];
    while ([s next]) {
        NSString *downloadPath = [s stringForColumn:@"DOWNLOAD_PATH"];
    }
